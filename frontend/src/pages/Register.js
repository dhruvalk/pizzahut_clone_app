  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex flex-col items-center justify-center h-screen">
        <div className="flex flex-col h-5/6 space-y-4">
          <div className="font-bold text-5xl text-left"> Create Account</div>
          <div className="text-left">Already have an account? Sign in</div>
          <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-row w-full">
              ...
              />
              <div>
                YES! Sign me up to receive EXCLUSIVE offers and deals from Pizza
                Hut via email and SMS. I agree to the Pizza hut Privacy Policy
                and Terms of Use.
              </div>
            </div>
            <button
