...
class MockPriceDataSource {
    ...
    private var prices = mutableListOf<Price>(
        Price(1,Type.`Personal Pan`,14.74),
        Price(1,Type.`Regular Pan`,21.12),
        Price(1,Type.`Large Pan`,12.00),
        Price(2,Type.`Personal Pan`,13.76),
        Price(2,Type.`Regular Pan`,21.64),
        Price(2,Type.`Large Pan`,15.87),
        Price(3,Type.`Personal Pan`,21.32),
        Price(3,Type.`Regular Pan`,11.69),
        Price(3,Type.`Large Pan`,14.21),
        Price(4,Type.`Personal Pan`,11.6),
        Price(4,Type.`Regular Pan`,11.99),
        Price(4,Type.`Large Pan`,24.68),
        Price(5,Type.`Personal Pan`,24.45),
        Price(5,Type.`Regular Pan`,22.53),
        Price(5,Type.`Large Pan`,21.67),
        Price(6,Type.`Personal Pan`,10.57),
        Price(6,Type.`Regular Pan`,20.32),
        Price(6,Type.`Large Pan`,17.21),
        Price(7,Type.`Personal Pan`,18.72),
        Price(7,Type.`Regular Pan`,11.73),
        Price(7,Type.`Large Pan`,18.15),
        Price(8,Type.`Personal Pan`,15.81),
        Price(8,Type.`Regular Pan`,18.04),
        Price(8,Type.`Large Pan`,16.84),
        Price(9,Type.`Personal Pan`,11.6),
        Price(9,Type.`Regular Pan`,17.97),
        Price(9,Type.`Large Pan`,11.3),
        Price(10,Type.`Personal Pan`,18.14),
        Price(10,Type.`Regular Pan`,21.56),
        Price(10,Type.`Large Pan`,18.22),
        Price(11,Type.`Personal Pan`,13.89),
        Price(11,Type.`Regular Pan`,20.02),
        Price(11,Type.`Large Pan`,16.79),
        Price(12,Type.`Personal Pan`,20.38),
        Price(12,Type.`Regular Pan`,10.92),
        Price(12,Type.`Large Pan`,20.68),
        Price(13,Type.`Personal Pan`,19.02),
        Price(13,Type.`Regular Pan`,16.17),
        Price(13,Type.`Large Pan`,11.59),
        Price(14,Type.`Personal Pan`,19.74),
        Price(14,Type.`Regular Pan`,15.66),
        Price(14,Type.`Large Pan`,23.96),
        Price(15,Type.`Personal Pan`,21.31),
        Price(15,Type.`Regular Pan`,17.01),
        Price(15,Type.`Large Pan`,11.78),
        Price(16,Type.`Personal Pan`,23.53),
        Price(16,Type.`Regular Pan`,15.69),
        Price(16,Type.`Large Pan`,19.24),
        Price(17,Type.`Personal Pan`,15.66),
        Price(17,Type.`Regular Pan`,22.91),
        Price(17,Type.`Large Pan`,13.99),
        Price(18,Type.`Personal Pan`,21.96),
        Price(18,Type.`Regular Pan`,24.96),
        Price(18,Type.`Large Pan`,21.11),
        Price(19,Type.`Personal Pan`,17.22),
        Price(19,Type.`Regular Pan`,16.08),
        Price(19,Type.`Large Pan`,16.75),
        Price(20,Type.`Personal Pan`,22.12),
        Price(20,Type.`Regular Pan`,16.95),
        Price(20,Type.`Large Pan`,20.08)
    )
